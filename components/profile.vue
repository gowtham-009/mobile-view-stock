<template>
    <div>
        ...
        <div class="w-full mx-auto bg-white shadow-sm rounded-lg p-6 mt-1" v-if="loading">
    ...
    <div v-if="content">
        <div class="flex items-center sm:hidden rounded-lg p-1" style="border: 1px solid gainsboro;">
            ...
            <svg class="pointer-events-none col-start-1 row-start-1 mr-2 w-6 h-6 self-center justify-self-end fill-gray-500"
